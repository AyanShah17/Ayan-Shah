        ...
        <div className="flex flex-col items-center space-y-4 text-center">
          <div className="space-y-2">
            <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl/none">
              Hi, I&apos;m <span className="gradient-text">Ayan Shah</span>
            </h1>
            <p className="mx-auto max-w-[700px] text-xl text-muted-foreground md:text-2xl">
              <span className="js-only">
                <span>Site Reliability Engineer | Software Engineer</span>
              </span>
              <noscript>
                <span>Site Reliability Engineer | Software Engineer | Python Expert | DevOps Specialist</span>
              </noscript>
            </p>
          </div>
          <div className="max-w-[700px] text-muted-foreground">
            <p className="text-lg">
              Automating deployments, monitoring systems, and ensuring 99.9% uptime with 1+ year of experience
            </p>
          </div>
          <div className="flex flex-col sm:flex-row gap-4 mt-6">
            ...
            <Button variant="outline" size="lg" className="rounded-full" asChild>
              <a href="/Ayan Shah Resume.pdf" download="Ayan Shah Resume.pdf">
          ...
          <div className="flex gap-4 mt-6">
            ...
            <Button variant="ghost" size="icon" asChild>
              <Link href="https://www.linkedin.com/in/ayan-shah/" target="_blank" rel="noopener noreferrer">
